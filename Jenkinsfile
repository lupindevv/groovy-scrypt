    ...
    stages {
        ...
        stage('Deploy') {
            input {
                ...
                ok "Done"
                parameters{
                    choice(name: 'ONE', choices: ['DEV', 'QA', 'PROD'], description: 'Please select the environment')
                    choice(name: 'TWO', choices: ['DEV', 'QA', 'PROD'], description: 'Please select the environment')
                }
            }
            steps {
                script {
